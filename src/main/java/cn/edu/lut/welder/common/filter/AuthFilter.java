package cn.edu.lut.welder.common.filter;

import cn.edu.lut.welder.common.utils.DataResult;
import cn.edu.lut.welder.service.HttpApiSessionService;
...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (Arrays.asList(whiteList).contains(url)) {
            ...
            request.setAttribute(HttpApiSessionService.USER_ID_KEY, claims.get(HttpApiSessionService.USER_ID_KEY));
            request.setAttribute(HttpApiSessionService.USER_USERNAME_KEY, claims.get(HttpApiSessionService.USER_USERNAME_KEY));
        }
